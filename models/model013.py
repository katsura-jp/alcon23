...
from .pre_act_oct_resnet import *

class PreActOctResNetGRU2(nn.Module):
    def __init__(self, num_classes, hidden_size=512, bidirectional=False, dropout=0.5, load_weight=None):
        super(PreActOctResNetGRU2, self).__init__()
        self.num_classes = num_classes
        self.hidden_size = hidden_size
        self.bidirectional = bidirectional

        self.resnet = pre_act_oct_resnet50(pretrained=False, num_classes=48, zero_init_residual=True)
...
def test():
    ...
    model = PreActOctResNetGRU2(48, 512, bidirectional=True)
